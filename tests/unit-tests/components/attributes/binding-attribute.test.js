...
describe("Binding Attributes", () => {
  ...
  describe("Add [class] attribute", () => {
    test("Should add the attribute", () => {
      ...
      const Basic = component("div", null, { "[class]": "value" });
      const content = node(Basic, { value: classValue });
  ...
  describe("Add [style] attribute", () => {
    test("Should add the attribute", () => {
      ...
      const Basic = component("div", null, { "[style]": "value" });
      const content = node(Basic, { value: styles });
  ...
  describe("Add [type] attribute to button", () => {
    test("Should add the attribute", () => {
      // ** Arrange
      const type = "button";
      const Basic = component("button", null, { "[type]": "value" });
      const content = node(Basic, { value: type });
  ...
  describe("Add [type] attribute to input", () => {
    test("Should add the attribute", () => {
      // ** Arrange
      const type = "number";
      const Basic = component("input", null, { "[type]": "value" });
      const content = node(Basic, { value: type });
  ...
  describe("Add new attribute", () => {
    test("Should add the attribute", () => {
      ...
      const Basic = component("input", null, { "[data-attr]": "value" });
      const content = node(Basic, { value: testValue });
