...
describe("Binding Attributes", () => {
  ...
  describe("Add [class] attribute", () => {
    test("Should add the attribute", () => {
      ...
      const content = node("div", { "[class]": "value" });

      // ** Act
      app(document.body, { value: classValue }, content);
  ...
  describe("Add [style] attribute", () => {
    test("Should add the attribute", () => {
      ...
      const content = node("div", { "[style]": "value" });

      // ** Act
      app(document.body, { value: styles }, content);
  ...
  describe("Add [type] attribute to button", () => {
    test("Should add the attribute", () => {
      // ** Arrange
      const type = "button";
      const content = node("button", { "[type]": "value" });

      // ** Act
      app(document.body, { value: type }, content);
  ...
  describe("Add [type] attribute to input", () => {
    test("Should add the attribute", () => {
      // ** Arrange
      const type = "number";
      const content = node("input", { "[type]": "value" });
