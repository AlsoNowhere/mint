...
export declare const refreshMIf: (mIf: I_mIf, blueprint: ElementBlueprint | ComponentBlueprint | IfBlueprint, parentElement: TElement, parentBlueprintList: Array<Blueprint>, blueprintIndex: number, options: {
