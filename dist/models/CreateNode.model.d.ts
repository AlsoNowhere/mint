...
export declare class CreateNode<T extends Object, U extends MintText | MintElement | MintComponent | MintTemplate | MintContext> implements INode<T> {
    mintNode: U;
    props: null | (T & IProps);
    content: null | Array<INode>;
    constructor(mintNode: U, props?: null | (T & IProps), content?: null | Array<INode>);
}
